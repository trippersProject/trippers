    ...
    <form method="post" id="placeForm">
        ...
        <div>
            ...
            <div class="container mt-5">
                <h5>프로필 이미지</h5>
                <p><?= $info['profile_image'];?></p>
                <img src="<?= base_url(get_place_upload_path().$info['profile_image']);?>" class="img-fluid" style="max-width: 30%;">
            </div>
            ...
            <div class="container mt-5">
                ...
                <img src="<?= base_url(get_place_upload_path().$info['banner_image']);?>" class="img-fluid" style="max-width: 100%;">
            </div>
            ...
            <h4>매장 소개</h4>
            <!-- 에디터 -->
                <textarea id="summernote" name="description"><?= $info['description'];?></textarea>
            <hr>
            
            <h4>홈페이지 URL</h4>
                <input type="text" name="homepage_url" id="homepage_url" class="form-control" value="<?= $info['homepage_url'];?>">
            <hr>

            <h4>SNS 링크 1</h4>
                <input type="text" name="sns_url_1" id="sns_url_1" class="form-control" value="<?= $info['sns_url_1'];?>">
            <hr>

            <h4>SNS 링크 2</h4>
                <input type="text" name="sns_url_2" id="sns_url_2" class="form-control" value="<?= $info['sns_url_2'];?>">
            <hr>

            <h4>SNS 링크 3</h4>
                <input type="text" name="sns_url_3" id="sns_url_3" class="form-control" value="<?= $info['sns_url_3'];?>">
            <hr>
        </div>
        <br/>
