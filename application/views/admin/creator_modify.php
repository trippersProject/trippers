    ...
    <form method="post" id="creatorForm">
        ...
        <div>
            ...
            <div class="container mt-5">
                <h5>현재 대표 이미지</h5>
                <p><?= $info['banner_image'];?></p>
                <img src="<?= base_url(get_creator_upload_path().$info['banner_image']);?>" class="img-fluid" style="max-width: 100%;">
            </div>
...
<script>
    ...
    function uploadImage(file) {
        ...
        $.ajax({
            url: '/admin/creator/upload_image',
            cache: false,
            contentType: false,
            processData: false,
            data: data,
    ...
    $('#submitBtn').click(function() {
        ...
        $.ajax({
            url: '/admin/creator/regi_creator',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
